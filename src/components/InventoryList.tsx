                    ...
                    <button
                      onClick={() => {
                        ...
                        if (input !== null && input.trim() !== "") {
                          const newSafety = Number(input);
                          if (!isNaN(newSafety) && newSafety >= 0) {
                            updateSafetyStock(item.id, newSafety);
                          } else {
                            alert("올바른 숫자를 입력해주세요.");
                          }
                        }
                      }}
                      className="bg-slate-600 text-white px-3 py-2 rounded font-bold hover:bg-slate-800 cursor-pointer text-sm transition-colors"
                    >
                      안전재고 설정
                    </button>
                    <button
                      ...
                      className="bg-red-600 text-white px-3 py-2 rounded font-bold hover:bg-red-800 cursor-pointer text-sm animate-pulse transition-colors"
                    >
                      삭제
                    </button>
                  </div>
